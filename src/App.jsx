...
function App() {
  ...
  Contact Me
          ...
          <div className={styles.column2}>
              <img src="/Portfolio-Website-Michael-Bui/quoc profile.png" alt="profile photo" style={{width: '90%', height: 'auto', borderRadius: '10px', marginBottom: '10px', marginTop: '20px', WebkitMaskImage: 'radial-gradient(circle, black 60%, transparent 100%)',
