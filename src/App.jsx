		...
		<div className='siteBackGround'>
			...
			<div className={styles.section}>
				<div className={styles.column1}>
					...
					<h2 style={{ color: '#ffffff', fontSize: '1.2em', fontWeight: 'normal', marginBottom: '30px', marginTop: '10px' }}>
						Aspiring Frontend Software Engineer | Creative UX/UI Designer.
					</h2>
					<div style={{ display: 'flex', gap: '30px' }}>
						<button onClick={() => (window.location.href = 'https://github.com/Keepgoing-30')}>View GitHub </button>
						<button onClick={() => (window.location.href = 'mailto:lovethebookofmormon@gmail.com')}>Contact Me</button>
					</div>
				</div>
				<div className={styles.column2}>
					...
					/>
					<p style={{ fontFamily: 'Arial, sans-serif', fontSize: '0.95em', color: '#ffffff' }}>
						<i>
							"Every effort today is a foundation for a stronger <br />
			...
			<div className={styles.section} style={{ flexDirection: 'column', alignItems: 'center', padding: '5px' }}>
				...
				<p style={{ color: '#ffffff', fontSize: '1.2em', fontWeight: 'normal', marginBottom: '2px', marginTop: '-10px' }}>
					Through various hands-on projects, I have developed a solid foundation in the following technologies to drive future
					success:
				</p>
			</div>
			<div
				className={styles.section}
				style={{ flexDirection: 'column', alignItems: 'center', padding: '50px 0', border: '#2f7cd8 solid 1px' }}
			>
			...
			<div className={styles.section} style={{ flexDirection: 'column', alignItems: 'center', padding: '5px' }}>
				...
				<p style={{ color: '#ffffff', fontSize: '1.2em', fontWeight: 'normal', marginBottom: '50px', marginTop: '-10px' }}>
					Technical certifications and credentials that fuel my growth as a Software Engineer:
				</p>
			</div>
			...
			>
				<h2 style={{ color: '#ffffff', fontSize: '1em', fontWeight: 'normal', marginBottom: '10px', marginTop: '10px' }}>
					© 2026 Michael Bui. All rights reserved.
				</h2>
			</div>
		</div>
	);
